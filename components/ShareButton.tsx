...
function getShareText(buddy: Buddy) {
...
function SocialIcon({ platform }: { platform: "x" | "linkedin" | "instagram" | "tiktok" }) {
...
export default function ShareButton({ buddy, onSave }: ShareButtonProps) {
  ...
  const handleShareX = () => {
    const { text, url } = getShareText(buddy);
    window.open(
  ...
  const socialButtons: { platform: "x" | "linkedin" | "instagram" | "tiktok"; label: string; onClick: () => void }[] = [
    { platform: "x", label: "X", onClick: handleShareX },
    { platform: "instagram", label: "IG", onClick: () => handleCopyForPlatform("instagram") },
    { platform: "tiktok", label: "TT", onClick: () => handleCopyForPlatform("tiktok") },
    { platform: "linkedin", label: "LI", onClick: handleShareLinkedIn },
  ];
